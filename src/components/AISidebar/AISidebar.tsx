...
export const AISidebar: React.FC<AISidebarProps> = ({
  ...
  return <div className="fixed right-0 top-0 w-80 h-full bg-background border-l shadow-lg flex flex-col transition-all duration-300 ease-in-out z-40 animate-slide-in-x\n">
      {/* Header */}
