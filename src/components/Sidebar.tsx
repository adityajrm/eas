...
const Sidebar: React.FC<SidebarProps> = ({ onCloseMobile }) => {
  ...
  return (
    <div className="w-64 bg-sidebar h-screen p-4 flex flex-col relative">
      {isMobile && (
        <Button 
          variant="ghost" 
          size="icon" 
          onClick={onCloseMobile} 
          className="absolute top-2 right-2 text-sidebar-foreground/70"
      ...
      <div className="pt-4 border-t border-sidebar-border">
        <div className="flex items-center justify-between mb-2">
          ...
          <Button 
            ...
            className="transition-all duration-200 mr-1 text-white bg-inherit"
          >
            {theme === 'light' ? (
